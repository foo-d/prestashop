...
[1]Pour les services :[/1] J\'accepte le lancement de la prestation de service et je reconnais perdre mon droit de révocation dès que la prestation est entièrement exécutée.',
  ...
  array (
    ...
    'Reorder' => 'Réorganiser',
    'Print out' => 'Imprimer',
    'Send reset link' => 'Envoyer le reset',
    'Back to login' => 'Retour connexion',
    'Back to Login' => 'Retour connexion',
    'Change Password' => 'Changer mot passe',
    'Clear' => 'Clair',
    'Do not show this popup again' => 'Ne pas afficher ce popup à nouveau',
    'Login' => 'Connexion',
    'Create an account' => 'Créer un compte',
    'Register' => 'Registre',
    'Share:' => 'Partager:',
  ...
  array (
    ...
    'Panel Tool' => 'Outil panneau',
    'Layout Mod' => 'Modèle de mise en page
',
    'Float Header' => 'En-tête de flotteur',
    'Live Theme Editor' => 'Éditeur de thème en direct',
    'Those Images in folder YOURTHEME/assets/img/patterns/' => 'Ces images dans le dossier YOURTHEME / assets / img / patterns /',
    'Attachment' => 'Attachement',
    'Not set' => 'Pas encore défini',
    'Position' => 'Position',
    'Repeat' => 'Répéter',
    'Inherit' => 'Hériter',
    'No blog at this time.' => 'Pas de blog en ce moment.',
    'View All' => 'Voir tout',
    'Post by' => 'Publié par',
    'Hits' => 'Hits',
    'smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value[\'date_add\']),"%e")' => 'smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value[\'date_add\']),"%e")',
    'smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value[\'date_add\']),"%m")' => 'smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value[\'date_add\']),"%m")',
    'smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value[\'date_add\']),"%Y")' => 'smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value[\'date_add\']),"%Y")',
    'In' => 'Dans',
    'Comment' => 'Commentaire',
    'Posted By' => 'Posté par',
    'On' => 'Sur',
    'Hit' => 'Frappé',
    'htmlspecialchars(smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value[\'date_add\']),"%A"), ENT_QUOTES, \'UTF-8\', true)' => 'htmlspecialchars(smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value[\'date_add\']),"%A"), ENT_QUOTES, \'UTF-8\', true)',
    'htmlspecialchars(smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value[\'date_add\']),"%B"), ENT_QUOTES, \'UTF-8\', true)' => 'htmlspecialchars(smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value[\'date_add\']),"%B"), ENT_QUOTES, \'UTF-8\', true)',
    'htmlspecialchars(smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value[\'date_add\']),"%e"), ENT_QUOTES, \'UTF-8\', true)' => 'htmlspecialchars(smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value[\'date_add\']),"%e"), ENT_QUOTES, \'UTF-8\', true)',
    'htmlspecialchars(smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value[\'date_add\']),"%Y"), ENT_QUOTES, \'UTF-8\', true)' => 'htmlspecialchars(smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value[\'date_add\']),"%Y"), ENT_QUOTES, \'UTF-8\', true)',
    'Read more' => 'Lire la suite',
    'Setting' => 'Réglage',
    'View my customer account' => 'Voir mon compte client',
    'Sign out' => 'Se déconnecter',
    'Log in to your customer account' => 'Connectez-vous à votre compte client',
    ...
    'Compare' => 'Comparer',
    'Account' => 'Compte',
    'Call: [1]%phone%[/1]' => 'Appel: [1]%phone%[/1]',
    'Mail us: [1]%email%[/1]' => 'Ecrivez-nous: [1]%email%[/1]',
    'Sorry, We are updating data, please come back later!!!!' => 'Désolé, nous mettons à jour les données, s\'il vous plaît revenir plus tard !!!!',
    'htmlspecialchars(smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value->date_add),"%A"), ENT_QUOTES, \'UTF-8\', true)' => 'htmlspecialchars(smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value->date_add),"%A"), ENT_QUOTES, \'UTF-8\', true)',
    'htmlspecialchars(smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value->date_add),"%B"), ENT_QUOTES, \'UTF-8\', true)' => 'htmlspecialchars(smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value->date_add),"%B"), ENT_QUOTES, \'UTF-8\', true)',
    'htmlspecialchars(smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value->date_add),"%e"), ENT_QUOTES, \'UTF-8\', true)' => 'htmlspecialchars(smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value->date_add),"%e"), ENT_QUOTES, \'UTF-8\', true)',
    'htmlspecialchars(smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value->date_add),"%Y"), ENT_QUOTES, \'UTF-8\', true)' => 'htmlspecialchars(smarty_modifier_date_format(strtotime($_smarty_tpl->tpl_vars[\'blog\']->value->date_add),"%Y"), ENT_QUOTES, \'UTF-8\', true)',
    'Tags:' => 'Mots clés:',
    'In Same Category' => 'Dans la même catégorie',
    'Related by Tags' => 'Associé par Tags',
    'Sorry, This blog is not avariable. May be this was unpublished or deleted.' => 'Désolé, ce blog n\'est pas obligatoire. Peut-être est-il inédit ou supprimé.',
    'January' => 'janvier',
    'February' => 'février',
    'March' => 'Mars',
    'April' => 'avril',
    ...
    'November' => 'novembre',
    'December' => 'décembre',
    'Filter Blogs By Tag' => 'Filtrer des blogs par étiquette',
    'Filter Blogs By Blogger' => 'Filtrer des blogs par Blogger',
    'Lastest Blogs' => 'Derniers blogs',
    'RSS' => 'RSS',
    'Sorry, We are update data, please come back later!!!!' => 'Désolé, nous sommes des données de mise à jour, s\'il vous plaît revenir plus tard !!!!',
    'Like This' => 'Comme ça',
    'Twitter' => 'Gazouillement',
    'Products Comparison' => 'Comparaison des produits',
    'Features:' => 'Traits:',
    'No features to compare' => 'Aucune fonctionnalité à comparer',
    'There are no products selected for comparison.' => 'Il n\'y a pas de produits sélectionnés pour la comparaison.',
    'Remove from Compare' => 'Supprimer de Comparer',
    'Add to Compare' => 'Ajouter pour comparer',
    'Add to Cart' => 'Ajouter panier',
    'Remove from Wishlist' => 'Supprimer du panier',
    'Add to Wishlist' => 'Ajouter à ma liste',
    'Newsletter' => 'Nouvelles lettre',
