...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  ...
  'unifunc' => 'content_6046d282499961_09682111',
...
function content_6046d282499961_09682111 (Smarty_Internal_Template $_smarty_tpl) {
?>    
        ...
        <a class="nav-link has-category" href="http://localhost/prestashop/" target="_self">
                            
                            <span class="menu-title">Accueil</span>
                                                        </a>
    </li>
    <li data-menu-type="url" class="nav-item  " >
        <a class="nav-link has-category" href="http://localhost/prestashop/17-notre-carte" target="_self">
                            
                            <span class="menu-title">Notre carte</span>
                                                        </a>
    </li>
    ...
    <li data-menu-type="url" class="nav-item  " >
        <a class="nav-link has-category" href="http://localhost/prestashop/blog.html" target="_self">
                            
                            <span class="menu-title">Blog</span>
                                                        </a>
    </li>
    <li data-menu-type="controller" class="nav-item  " >
        <a class="nav-link has-category" href="http://localhost/prestashop/nous-contacter" target="_self">
                            
                            <span class="menu-title">Contactez</span>
                                                        </a>
    </li>
</ul></div>
            </nav>
